...
<template>
  <section class="checkout-page page-shell">
    <div class="checkout-page__container container">
      ...
      <div class="page-head">
        <div>
          <h1 class="checkout-page__title page-title">Оформление заказа</h1>

          <p class="checkout-page__subtitle page-subtitle">
            Проверьте корзину, выберите адрес доставки и перейдите к онлайн-оплате после создания заказа.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <NuxtLink to="/" class="button"> Найти ресторан </NuxtLink>
      </div>
      ...
      <div v-else class="checkout-page__layout">
        ...
        <div class="checkout-page__main">
              ...
              >
                ...
                <div class="checkout-address__body">
                  <div class="checkout-address__top-line">
                    <span v-if="addr.label" class="checkout-address__label">
                      {{ addr.label }}
                    </span>
                  ...
                  <div v-if="addr.postal_code" class="checkout-address__postal">
                    {{ addr.postal_code }}
                  </div>
                </div>
              </label>

              <NuxtLink to="/profile/addresses" class="checkout-card__link">
                Управлять адресами
              </NuxtLink>
            </div>
          </section>
          ...
          <section class="checkout-card surface-card">
            <h2 class="checkout-card__title section-title">Маршрут доставки</h2>
            ...
            <p v-else class="checkout-card__hint checkout-card__hint--warning">
              Выберите адрес с координатами, чтобы увидеть маршрут и стоимость
              доставки.
            </p>
          </section>
        ...
        <aside class="checkout-page__sidebar">
          <section class="checkout-card checkout-card--sticky surface-card">
            ...
            <div class="checkout-summary">
              ...
              <div v-if="deliveryQuote" class="checkout-summary__route">
                Минимальное время ожидания ~{{ deliveryQuote.eta_minutes }}
                мин
              </div>
            ...
            >
              Не удалось рассчитать доставку. Проверьте адрес или попробуйте
              позже.
            </p>
