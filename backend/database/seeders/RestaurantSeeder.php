        ...
        foreach ($items as $item) {
            ...
            $restaurant = Restaurant::updateOrCreate(
                ...
                [
                    ...
                    'phone' => $item['phone'],
                    'is_active' => true,
                    'accepts_orders' => $item['accepts_orders'] ?? true,
                    'timezone' => $item['timezone'] ?? 'Europe/Moscow',
                    'opens_at' => $item['opens_at'] ?? '10:00',
                    'closes_at' => $item['closes_at'] ?? '23:00',
    ...
    private function restaurants(): array
    {
        return [
            [
                ...
                'phone' => '+7911' . rand(1000000, 9999999),
                'prep_time_min' => 25,
                'prep_time_max' => 45,
                'opens_at' => '09:00',
                'closes_at' => '22:00',
                'logo' => 'media/restaurants/novgorod_dvorik.webp',
                'address' => [
            ...
            [
                ...
                'phone' => '+7921' . rand(1000000, 9999999),
                'prep_time_min' => 30,
                'prep_time_max' => 55,
                'opens_at' => '11:00',
                'closes_at' => '02:00',
                'logo' => 'media/restaurants/ilmen_sushi.webp',
                'address' => [
            ...
            [
                ...
                'phone' => '+7951' . rand(1000000, 9999999),
                'prep_time_min' => 15,
                'prep_time_max' => 30,
                ...
                'logo' => 'media/restaurants/ganza_burger.webp',
                'address' => [
            ...
            [
                ...
                'phone' => '+7902' . rand(1000000, 9999999),
                'prep_time_min' => 20,
                'prep_time_max' => 40,
                'logo' => 'media/restaurants/detinec_gril.webp',
                'address' => [
            ...
            [
                ...
                'prep_time_min' => 20,
                'prep_time_max' => 35,
                'logo' => 'media/restaurants/volhov_trapeza.webp',
                'address' => [
            ...
            [
                ...
                'phone' => '+7960' . rand(1000000, 9999999),
                'prep_time_min' => 25,
                'prep_time_max' => 40,
                'logo' => 'media/restaurants/sofiyskaya_pizza.webp',
                'address' => [
            ...
            [
                ...
                'prep_time_min' => 15,
                'prep_time_max' => 25,
                'logo' => 'media/restaurants/lapsha_sadko.webp',
                'address' => [
            ...
            [
                ...
                'phone' => '+7953' . rand(1000000, 9999999),
                'prep_time_min' => 10,
                'prep_time_max' => 20,
                'logo' => 'media/restaurants/vityaz_kebab.webp',
                'address' => [
            ...
            [
                ...
                'phone' => '+7908' . rand(1000000, 9999999),
                'prep_time_min' => 20,
                'prep_time_max' => 50,
                'logo' => 'media/restaurants/pryanik_domik.webp',
                'address' => [
            ...
            [
                ...
                'prep_time_min' => 15,
                'prep_time_max' => 30,
                'logo' => 'media/restaurants/pelmeni_master.webp',
                'address' => [
